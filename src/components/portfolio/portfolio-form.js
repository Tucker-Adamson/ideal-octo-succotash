...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://tuckeradamson.devcamp.space/portfolio/portfolio_items",
            apiAction: 'post'
        }
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://tuckeradamson.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: 'patch',
        ...
        axios({
            ...
            .then(response => {
                if (this.state.editMode) {
                    this.props.hanldeEditFormSubmission();
                } else {
            ...
            <form onSubmit={this.handleSubmit} className="portfolio-form-wrapper">
                ...
                <div className="two-column">
                    ...
                    className="select-element">
                        <option value="eCommerece">eCommerce</option>
                ...
                <div className="image-uploaders">
                    {this.state.thumb_image_url && this.state.editMode ? (
                            <div class="portfolio-manager-image-wrapper"> 
